---
title: "셀프 이벤트 수집 및 데이터 파이프라인 구축기 — S3 다음 칸에 Athena를 놓을지 Mixpanel을 놓을지"
...
## S3에 쌓는 건 고른 게 아니라 이미 그렇게 돼 있었다
...
## 그래서 Firehose부터 Redshift까지 이 순서로
